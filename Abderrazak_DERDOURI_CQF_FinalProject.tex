...
xxxxxxxxx
\begin{figure}[H]
	\includegraphics[width = \textwidth]{Term_structure_01.png}
	\caption{Volatilité implicite: \(\mu_1=\mu_2=0.03, p=0.5, \sigma^2=0.04, \sigma_2^2=0.04 \ to \ 0.05\)}	
\end{figure}
...
\begin{figure}[H]
	\includegraphics[width = \textwidth]{IRS_Exposure_01.png}
\end{figure}

YYYYYYYYYYYYYYYYYYYYYYYYYYYYYY

\begin{figure}[H]
	\includegraphics[width = \textwidth]{CVA_Period_01.png}
\end{figure}
...
\begin{figure}[H]
	\includegraphics[width = \textwidth]{Term_structure_02.png}
\end{figure}


\begin{figure}[H]
	\includegraphics[width = \textwidth]{IRS_Exposure_02.png}
\end{figure}

\begin{figure}[H]
	\includegraphics[width = \textwidth]{CVA_Period_02.png}
\end{figure}

\begin{figure}[H]
	\includegraphics[width = \textwidth]{IncreasingExpectedExposure.png}
\end{figure}

\begin{figure}[H]
	\includegraphics[width = \textwidth]{IncreasingCVAPeriod.png}
\end{figure}
