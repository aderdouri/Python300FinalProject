...
Run: python -m unittest marketDataProcessing.CapATMStrikeTests.testATMStrike
...
class CapATMStrikeTests(TestCase):
    def testATMStrike(self):
        ...
        to the processedMarketData sheet in the marketData.xlsx file
        """
        print('ATM strikes for caps, preliminary computations')
        df = processMarketData()
        LiteLibrary.writeDataFrame(df, 'processedMarketData')
        print('See column ForwardSwapRate from the processedMarketData sheet in the marketData.xlsx file.')
