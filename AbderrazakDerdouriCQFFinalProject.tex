...
This work is two parts, the first part will focus on the calibration and pricing of interest rate derivatives in the framework of the Libor Market Model(LMM), the second part will consider the Credit Valuation Adjustment calculation (CVA) for an Interest Rate Swap (IRS).
This document is organized as follows: In section 2 we introduce the mathematical and financial foundations
behind the basic theory of interest rate derivatives. In section 3 we give a rather rigorous introduction to the Libor
Market Model. In section 4 we present the structure of our Python implementation, in section 5 we implement two approaches of calibration of the LMM, the first one is its calibration to Caps and the second one is the Rebonato's parametric approach, section 6 is dedicated to the Credit Value Adjustment calculation of an Interest Rate Swap. We conclude in section 7. 
All major results are visualized and the intermediate calculations are saved in a Pandas Data Frame. The programming language used is Python.
...
\begin{figure}[H]
	\includegraphics[width = \textwidth]{ForwardSwapRate.png}
...
\begin{figure}[H]
	\includegraphics[width = \textwidth]{StrippedCapletVolatilies.png}
...
\begin{figure}[H]
	\includegraphics[width = \textwidth]{InstantaneousVolatilityFunctions.png}
	\includegraphics[width = \textwidth]{ParametricCapletVolatiliy.png}
\end{figure}
...
\begin{figure}[H]
	\includegraphics[width = \textwidth]{ParametricCorrCapletVolatiliy.png}
	\includegraphics[width = \textwidth]{ParametricVSCorrCapletVolatiliy.png}
\end{figure}
...
\vskip 0.4cm
\begin{figure}[H]
	\includegraphics[width = \textwidth]{MonteCarloVSAnalyticCapPrice.png}
\end{figure}
...
\begin{figure}[H]
	\includegraphics[width = \textwidth]{ExponentialParametricCorrelation.png}
\end{figure}
...
\begin{figure}[H]
	\includegraphics[width = \textwidth]{ExponentialParametricDecayCorrelation.png}
\end{figure}
...
\begin{figure}[H]
	\includegraphics[width = \textwidth]{ReceiverSwaptionPriceStrikeLevel.png}
	\includegraphics[width = \textwidth]{PayerSwaptionPriceStrikeLevel.png}
\end{figure}
...
\begin{thebibliography}{99}
	...
	\emph{The SABR/LIBOR Market Model: Pricing, Calibration and Hedging for Complex Interest-Rate Derivatives} Feb 23, 2011	\bibitem{pa} Christian \bibitem{pa} Crispoldi and Gerald Wigger:
