...
Market Model and show how to calibrate the model to a real data set. In section 4 we use the model
to price a basic cap and swaption contract. We conclude in section 5. 
...
\begin{figure}[H]
	\includegraphics[width = \textwidth]{MoneCarloVSAnalyticCapPrice.png}
\end{figure}
...
\begin{figure}[H]
	\includegraphics[width = \textwidth]{ParametricCorrelation.png}
\end{figure}
